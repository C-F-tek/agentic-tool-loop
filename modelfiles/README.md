...
`modelfiles/` contains Ollama Modelfile templates and model configuration
examples. It does not contain model binaries.
...
- [Modelfile.qwen3coder-32k](Modelfile.qwen3coder-32k)
  - Qwen coder model template.
- [Modelfile.qwen3task-8k](Modelfile.qwen3task-8k)
  - Qwen task model template.
- [Modelfile.devstral-32k](Modelfile.devstral-32k)
  - Devstral model template.
- [Modelfile.Modelfile.qwen3task-8k](Modelfile.Modelfile.qwen3task-8k)
  - Historical/compatibility task Modelfile template.
