function Get-AICarmineClineTaskBootstrap {
    ...
    try {
        ...
        $lines = @(
            ...
            '- Core: aicarmine_repo_state, aicarmine_repo_search_det, aicarmine_repo_validate, aicarmine_repo_code',
            '- Data: aicarmine_rag, aicarmine_sqlite_readonly, aicarmine_project_memory',
            '- Jobs: aicarmine_job_artifact, aicarmine_job_view, aicarmine_git_readonly',
            '- Ops: aicarmine_codex_ops, aicarmine_repo_symbol_index, aicarmine_test_discovery, aicarmine_code_dep_graph',
            '- Refactor: aicarmine_refactor (libcst, rope, bowler; git-tracked scope-aware)',
            '- Agents: aicarmine_local_subagent, aicarmine_agentic_loop_client, aicarmine_ollama_subagent',
            '- Format: aicarmine_prettier, aicarmine_biome, aicarmine_ruff, aicarmine_eslint, aicarmine_black',
            '',
