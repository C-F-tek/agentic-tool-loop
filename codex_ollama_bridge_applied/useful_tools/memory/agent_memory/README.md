# codex_ollama_bridge_applied/useful_tools/memory/agent_memory

`agent_memory/` contains applied agent memory models, policy, storage,
SQLite-backed store/report helpers and review/routing utilities.
...
- [models.py](models.py), [policy.py](policy.py), [state.py](state.py), [storage.py](storage.py)
  - Memory models, policy, state and storage helpers.
- [sqlite_store.py](sqlite_store.py), [sqlite_cli.py](sqlite_cli.py), [sqlite_report.py](sqlite_report.py)
  - SQLite-backed memory store and report helpers.
- [routing_cli.py](routing_cli.py), [routing_report.py](routing_report.py), [routing_requests.py](routing_requests.py)
  - Memory routing helpers.
- [review/](review/)
  - Memory review CLI package.
