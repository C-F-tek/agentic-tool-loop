# codex_ollama_bridge_applied/useful_tools/memory

`memory/` contains applied memory helper packages, including agent memory,
SQLite-related package markers and policy/review helpers.
...
- [agent_memory/](agent_memory/)
  - Agent memory models, policy, SQLite store and review helpers.
- [fts5/](fts5/), [persistent/](persistent/), [pointers/](pointers/), [sqlite/](sqlite/), [volatile/](volatile/)
  - Memory package markers and namespace surfaces.
