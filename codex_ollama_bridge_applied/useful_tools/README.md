# codex_ollama_bridge_applied/useful_tools

`codex_ollama_bridge_applied/useful_tools/` contains copied context, memory,
chunk and pointer helper packages used by the applied local integration.
...
- [chunks/](chunks/)
  - Code/evidence/proposal chunk package markers.
- [context/](context/)
  - Context pack, RAG, heap reload and agent context helpers.
- [memory/](memory/)
  - Memory store, policy, SQLite and review helpers.
- [pointers/](pointers/)
  - Pointer graph, resume and revision context package markers.
