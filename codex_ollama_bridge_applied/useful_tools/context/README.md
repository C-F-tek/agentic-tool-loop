# codex_ollama_bridge_applied/useful_tools/context

`codex_ollama_bridge_applied/useful_tools/context/` contains context-building,
RAG, reload, file-reference and agent-context helper packages.
...
- [agent_context/](agent_context/)
  - Agent-oriented context pack, RAG and inventory helpers.
- [heap_context_memory_reload/](heap_context_memory_reload/)
  - Heap/context reload and dynamic context helpers.
- [context_pack/](context_pack/), [context_reload/](context_reload/), [file_refs/](file_refs/)
  - Package markers for context utilities.
