...
`ai_context_pack/` builds agent context packs from selected files, profiles and
Markdown renderers.
...
- [common.py](common.py), [files.py](files.py), [markdown.py](markdown.py), [profiles.py](profiles.py)
  - Shared helpers, file selection, Markdown rendering and profile definitions.
