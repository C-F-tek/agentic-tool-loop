...
`shared_toolbox_bundle/` contains helper modules for collecting, summarizing
and rendering shared toolbox bundle information.
...
- [collection.py](collection.py), [tooling.py](tooling.py), [provider_state.py](provider_state.py)
  - Bundle collection, tooling and provider-state helpers.
- [summary.py](summary.py), [common.py](common.py), [cli.py](cli.py)
  - Summary, shared utilities and CLI entrypoint.
