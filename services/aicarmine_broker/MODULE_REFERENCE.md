...
| `application/evidence/coverage_scorer.py` | Diagnostic-only evidence coverage scorer. It summarizes file, directory, repository and code-product coverage into `evidence_coverage` without changing finalization gates. |
