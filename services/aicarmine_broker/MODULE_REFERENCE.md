...
| `application/planner/required_progress.py` | Structured companion model for legacy `required_next_progress` text. It adds `required_next_progress_model` diagnostics while preserving the human text and existing validator behavior. |
