...
DEFAULT_PLANNER_MODEL = "Qwen3-6-35B-A3B-UD-IQ2_M:latest"
...
def load_broker_config_from_env(env: EnvMapping | None = None) -> BrokerConfig:
    ...
    workspace = _resolved_path(
        env_str(
            ...
            r"C:\Users\someo\agentic-tool-loop\state\codex_bridge\agentic_loop_client\port-3579\workspace",
            env,
        ),
    ...
    return BrokerConfig(
        ...
        ollama_task_model=env_first(
            ...
            "Qwen3-6-35B-A3B-UD-IQ2_M:latest",
            env,
        ),
