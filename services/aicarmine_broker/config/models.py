...
def load_broker_config_from_env(env: EnvMapping | None = None) -> BrokerConfig:
    ...
    return BrokerConfig(
        ...
        result_compact_chars=env_int("AICARMINE_AGENTIC_RESULT_COMPACT_CHARS", 12000, env),
        ...
        prompt_compact_ratio=env_float("AICARMINE_AGENTIC_PLANNER_PROMPT_COMPACT_RATIO", 0.5, env),
        ...
        native_max_parallel_readonly=env_int("AICARMINE_AGENTIC_PLANNER_NATIVE_MAX_PARALLEL_READONLY", 4, env),
        ...
        agent_public_result_inline_chars=env_int("AICARMINE_AGENT_PUBLIC_RESULT_INLINE_CHARS", 12000, env),
        ...
        planner_intrinsic_context_max_chars=env_int("AICARMINE_PLANNER_INTRINSIC_CONTEXT_MAX_CHARS", 5000, env),
        planner_intrinsic_rag_top_k=env_int("AICARMINE_PLANNER_INTRINSIC_RAG_TOP_K", 3, env),
        planner_intrinsic_rag_char_budget=env_int("AICARMINE_PLANNER_INTRINSIC_RAG_CHAR_BUDGET", 900, env),
        ...
        planner_rag_rerank_timeout_seconds=env_float("AICARMINE_PLANNER_RAG_RERANK_TIMEOUT_SECONDS", 2.0, env),
