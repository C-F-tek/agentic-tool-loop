...
# Patch C con stringa alternativa (senza indentazione extra)
...
if old_code in content:
    ...
    # Cerca pattern con spazi diversi
    if '"speculative_terms")' in content:
        print('Pattern parziale trovato - stringa originale presente')
    else:
        print('Pattern non trovato - controllo contenuto...')
