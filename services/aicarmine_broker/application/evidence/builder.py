...
# Extracted builder modules — semantic classification, validation, and path logic
from aicarmine_broker.application.evidence.builder_core import (
    compute_preplanner_intent as _preplanner_semantic_intent_from_orientation,
    classify_semantic_with_preplanner as _semantic_classification_with_preplanner_intent,
    goal_requests_code_product_from_semantics as _goal_requests_code_product_from_semantics,
    goal_requests_apply_from_semantics as _goal_requests_apply_from_semantics,
    build_micro_batch_contract as _micro_batch_contract_from_candidates,
)
from aicarmine_broker.application.evidence.builder_validation import (
    compute_post_write_validation_contract as _post_write_validation_contract,
    validation_covers_modified_files as _validation_covers_modified_files,
    post_write_validation_candidates as _post_write_validation_candidates,
    path_covers_target as _path_covers_target,
)
from aicarmine_broker.application.evidence.builder_paths import (
    collect_result_paths as _collect_result_paths,
    tool_result_paths as _tool_result_paths,
    goal_mentions_repo_path as _goal_mentions_repo_path,
)
