...
def planner_decision(
    ...
    append_agent_event(
        ...
        f"Planner request step={step} timeout={planner_stream_timeout_seconds}s.",
        {
            ...
            "intrinsic_context_chars": (_dict_from_mapping(intrinsic_context.get("budget_report"))).get("intrinsic_context_chars"),
            "intrinsic_rag_status": (_dict_from_mapping(intrinsic_context.get("retrieved_rag_chunks"))).get("status"),
            "intrinsic_rag_rerank_status": (_dict_from_mapping(_dict_from_mapping(intrinsic_context.get("retrieved_rag_chunks"))).get("rerank") or {}).get("status"),
