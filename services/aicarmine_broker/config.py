...
AGENTIC_PLANNER_NUM_CTX_REQUESTED: int = env_int("AICARMINE_AGENTIC_PLANNER_NUM_CTX", 12288)
AGENTIC_PLANNER_NUM_CTX_CAP: int = env_int("AICARMINE_AGENTIC_PLANNER_NUM_CTX_CAP", 12288)
