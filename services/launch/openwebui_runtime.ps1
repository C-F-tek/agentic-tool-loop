...
$CUDA_VISIBLE_DEVICES = Set-UserEnvValue "CUDA_VISIBLE_DEVICES" $config.CUDA_DEVICE
...
$AICarminePersistentConfig = @{
    ...
    AICARMINE_AGENTIC_PLANNER_NUM_CTX = "14336"
    AICARMINE_AGENTIC_PLANNER_NUM_CTX_CAP = "14336"
