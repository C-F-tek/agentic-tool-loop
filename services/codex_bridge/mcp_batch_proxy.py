...
# SERVER_SCRIPTS uses relative paths from SERVICES_ROOT so it works on any machine.
SERVER_SCRIPTS: Dict[str, str] = {
    "aicarmine_rag": str(SERVICES_ROOT / "rag_mcp_server.py"),
    "aicarmine_repo_state": str(SERVICES_ROOT / "repo_state_mcp_server.py"),
    "aicarmine_repo_validate": str(SERVICES_ROOT / "repo_validate_mcp_server.py"),
    "aicarmine_repo_search_det": str(SERVICES_ROOT / "repo_search_det_mcp_server.py"),
    "aicarmine_repo_code": str(SERVICES_ROOT / "repo_code_mcp_server.py"),
    "aicarmine_codex_ops": str(SERVICES_ROOT / "ops_mcp_server.py"),
    "aicarmine_job_view": str(SERVICES_ROOT / "job_view_mcp_server.py"),
    "aicarmine_job_artifact": str(SERVICES_ROOT / "job_artifact_mcp_server.py"),
    "aicarmine_git_readonly": str(SERVICES_ROOT / "git_readonly_mcp_server.py"),
    "aicarmine_sqlite_readonly": str(SERVICES_ROOT / "sqlite_readonly_mcp_server.py"),
    "aicarmine_project_memory": str(SERVICES_ROOT / "project_memory_mcp_server.py"),
    "aicarmine_code_dep_graph": str(SERVICES_ROOT / "code_dep_graph_mcp_server.py"),
    "aicarmine_repo_symbol_index": str(SERVICES_ROOT / "repo_symbol_index_mcp_server.py"),
    "aicarmine_test_discovery": str(SERVICES_ROOT / "test_discovery_mcp_server.py"),
    "aicarmine_index_bridge": str(SERVICES_ROOT / "index_bridge_mcp_server.py"),
}
